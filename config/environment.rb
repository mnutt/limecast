...
Rails::Initializer.run do |config|
  ...
  config.active_record.observers = :user_observer, :queued_feed_observer
...
%w{file_size duration convenience array_ext object_ext date_ext
   hash_ext string_ext integer_ext numeric_ext pretty_printer podcast_processor source_processor}.each do |lib|
  require lib
end
