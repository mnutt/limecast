...
Rails::Initializer.run do |config|
  ...
  config.active_record.observers = :user_observer, :podcast_observer
...
# Load /lib files
%w{file_size duration convenience array_ext object_ext date_ext hash_ext string_ext integer_ext}.each do |lib|
  require lib
end
