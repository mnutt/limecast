...
describe EpisodesController do
  describe "route generation" do
    ...
    it "should map { :podcast => 'Podcast', :controller => 'episodes', :action => 'search' } to /Podcast/episodes/search" do
  ...
  describe "route recognition" do
    ...
    it "should generate params { :podcast => 'Podcast', :controller => 'episodes', :action => 'search' } from GET /Podcast/episodes/search" do
